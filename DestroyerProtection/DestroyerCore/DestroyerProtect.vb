Imports DestroyerProtection.Destroyer.AntiAnalysis
Imports DestroyerProtection.Destroyer.AntiDebug
Imports DestroyerProtection.Destroyer.AntiDump
Imports DestroyerProtection.Destroyer.AntiVirtualMachine
        ...
        Private Shared Sub tmrFormMonitor_Tick(ByVal sender As Object, ByVal e As EventArgs)
            If VMscan = VMScanType.By_Generalized_Name Then
                ...
                If VMDetection = OldAntiVM.ResultType.Danger Then
                    ...
                    _LogResult += "Virtual Machine Detected : " & VMDescription & vbNewLine
                    Execution_End()
